...
export class SampleTableComponent {
  ...
  samples = [
    ...
    { id: 3, name: "Лучшие студенты в верху списка (по колличеству набарнных баллов)", description: "В выборке будут показаны студенты у которых наивысшее суммарное количество баллов" },
